...
class CustomerController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('time_work.query_table')->with('data',$data);
    }
//    show input form
    public function scedual()
    {
        return view('time_work.home');
    }
...
//           ->where('status','=','Part time');
        return redirect(route('time_work.query_table'));
    }
...
//    show id on url
    public function show($id)
    {
        ...
        return view('time_work.update-page')->with('post', $post);
    }
