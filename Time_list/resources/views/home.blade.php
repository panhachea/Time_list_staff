                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/show/{{ $datas->id }}">
                                <i class="glyphicon glyphicon-home" type="submit">Edit</i>
                            </a>
                            <i class="glyphicon glyphicon-trash" type="submit" data-toggle="modal"
                                  data-target="#modalDelete-{{ $datas->id }}" style="color:#cc0000; margin-left: 20px">Delete
                            </i>
                        </td>
                    </tr>
                @endforeach
